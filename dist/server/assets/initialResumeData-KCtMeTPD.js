...
var GITHUB_REPO_URL = "https://github.com/JOYCEQL/magic-resume";
...
var getBorderRadiusValue = (config) => {
	if (!config) return "0";
...
//#endregion
//#region src/config/initialResumeData.ts
var initialResumeData_exports = /* @__PURE__ */ __exportAll({
	blankResumeState: () => blankResumeState,
	blankResumeStateEn: () => blankResumeStateEn,
	initialResumeState: () => initialResumeState,
	initialResumeStateEn: () => initialResumeStateEn
});
...
//#endregion
export { initialResumeStateEn as a, getBorderRadiusValue as c, GITHUB_REPO_URL as d, PDF_EXPORT_CONFIG as f, initialResumeState as i, getRatioMultiplier as l, blankResumeStateEn as n, DEFAULT_CONFIG as o, initialResumeData_exports as r, THEME_COLORS as s, blankResumeState as t, DEFAULT_FIELD_ORDER as u };
