...
// Dashboard: Analytics Chart (Flat Gradient Blue & Purple)
export const IconDashboard: React.FC<IconProps> = ({ size = 24, className, active }) => (
  <svg width={size} height={size} viewBox="0 0 40 40" fill="none" xmlns="http://www.w3.org/2000/svg" className={className}>
    {/* Background Card */}
    <rect x="4" y="4" width="32" height="32" rx="6" fill={active ? "#722ED1" : "#434343"} />

    {/* Chart Bars */}
    <rect x="10" y="24" width="4" height="10" rx="2" fill="white" />
    <rect x="18" y="16" width="4" height="18" rx="2" fill="white" />
    <rect x="26" y="10" width="4" height="24" rx="2" fill="white" />

    {/* Trend Line Dot */}
    <circle cx="20" cy="12" r="3" fill="#FA8C16" />
  </svg>
);
