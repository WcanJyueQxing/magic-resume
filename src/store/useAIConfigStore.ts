...
interface AIConfigState {
  ...
  setOllamaApiEndpoint: (endpoint: string) => void;
  setOllamaModelId: (modelId: string) => void;
...
export const useAIConfigStore = create<AIConfigState>()(
  persist(
    (set, get) => ({
      ...
      setOllamaApiEndpoint: (endpoint: string) =>
        set({ ollamaApiEndpoint: endpoint }),
      setOllamaModelId: (modelId: string) => set({ ollamaModelId: modelId }),
      isConfigured: () => {
        const state = get();
